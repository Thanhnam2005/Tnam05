...
export function TaiXuongPDF({ urlPDF }: ThuocTinhTaiXuongPDF) {
  if (!urlPDF) {
    console.warn("Không có URL PDF được cung cấp.")
    return null
  }
  ...
  return (
    <div className="mt-6 bg-green-50 dark:bg-green-900/30 rounded-lg p-4 border border-green-200 dark:border-green-700">
      ...
      <Button
        asChild
        className="w-full transition-transform duration-300 transform hover:scale-105 bg-green-500 hover:bg-green-600 text-white"
      >
        <a
          href={urlPDF}
